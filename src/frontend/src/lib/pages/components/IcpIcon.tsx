...
interface IcpIconProps extends React.SVGProps<SVGSVGElement> {
    className?: string;
    size?: number;
}

export default function IcpIcon({ className, size, ...props }: IcpIconProps) {
    return (
        <svg
        ...
        >
            <defs>
                <style type="text/css">
                    {`
            .icp-gradient-1 { fill: url(#gradient-1); }
            .icp-gradient-2 { fill: url(#gradient-2); }
            .icp-center { fill-rule: evenodd; clip-rule: evenodd; fill: #29ABE2; }
          `}
                </style>
